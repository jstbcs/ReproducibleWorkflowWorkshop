...
> -   Git is a essentially a program on your computer, you have to communicate with it.
...
## Create and set a personal access token (PAT)
...
> -   Here is the best [tutorial](https://thenewstack.io/dont-mess-with-the-master-working-with-branches-in-git-and-github/) I could find on branches: <https://thenewstack.io/dont-mess-with-the-master-working-with-branches-in-git-and-github/>.
> -   For working in a professional environment: A tutorial on pull requests: <https://www.atlassian.com/git/tutorials/making-a-pull-request>
